...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { description: @promotion.description, promocode: @promotion.promocode, title: @promotion.title, user_id: @promotion.user_id } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { description: @promotion.description, promocode: @promotion.promocode, title: @promotion.title, user_id: @promotion.user_id } }
